...
contract CommissionEscrowTest is Test {
    ...
    function test_EscrowHoldsFundsBeforeWorkBegins() public {
        ...
        (address c, address a, uint256 amount, , CommissionEscrow.CommissionStatus status,,) = escrow.getCommission(commissionId);
    ...
    function test_MultipleCommissions() public {
        ...
        vm.prank(collector);
        uint256 commissionId2 = escrow.createCommission{value: 2 ether}(otherArtisan, block.timestamp + DEADLINE, arbiter);
